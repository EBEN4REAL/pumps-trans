export const FRENCH_TRANSLATIONS = {
    text: {
        ...
        calendar: {
            today: 'dkjfka',
            yesterday: 'wuahj',
            last7Days: 'ka 7 kajkdj',
            lastWeek: 'ad wf',
            last30Days: 'cac 30 gf',
            lastMonth: 'adfadf',
            dateRange: 'jxjj a af we',
            selectDate: 'cvzvc a cva'
        },
        ...
        cMasterLayout: {
            dashboard: 'afda',
            stationManagement: 'cvzvc bmbvcfgc',
            priceManagement: 'zcvavad hgvv', 
            updatePrice: 'ppjpojo aeses',
            report: 'mnvmvg',
            companySales: 'rxdx hbh',
            sales: 'hkhkh',
            varianceReport: 'jojio eaqedee',
            tanksFilledReport: 'hkjhk stdtd pkpkp',
            peddlingManagement: 'hkh sersdss',
            peddling: 'jlkjkj',
            orders: 'warars',
            products: 'kjl',
            manageDrivers: 'etttr hgkjhk',
            manageTrucks: 'dtd vyghvhhvh',
            ourDealers: 'rxfx kpnn',
            retailOutlets: 'hgj nmvcgc',
            corporateCustomers: 'chhgf iioio',
            retainership: 'ouoo',
            walletFundRequest: 'ajfljd hkk rssrv',
            customers: 'ijpxzo',
            manageExpenses: 'xvkl vzfs',
            expenses: 'vcois',
            categories: 'kjclj',
            bankAccounts: 'woija gdsfg',
            zones: 'vjkjzk',
            outstandingPayments: 'ajkdhkj jakjf',
            payments: 'nsjkdjsk',
            signOut: 'odaj oaufi',
            confirmLogout: 'ijfk uadf reja adj wjaj?',
            profile: 'dfda',
        },
        // Company Dashboard
        cDashboard: {
            salesVTarget: 'vz vs ds',
            dealers: 'zcvzcvz',
            branches: 'hdg',
            tanksFilled: 'sfd hghrh',
            totalPumps: 'zfvz Number Of Pumps',
        ...
        bExpenses: {
            ...
            accountNumberMissing: `You currently don't have an account, please add an account first, in order to record expenses`
        },
        // Branch Wallet
        bWallet: {
        ...
        // Login
        login: {
            selectALanguage: 'kakfjkau a jljkjk',
            selectACountry: 'kadlfjkl a owhohjo',
            signIn: 'ksksk | KSKSk',
            noAccount: `dklfj jaj dioh fnbsjfi?`,
            signUp: 'owow | OWOW', 
            forgotPassword: 'kjkljs ijhbxoh?',
            hello: 'voziuoi',
            user: 'ckoo!',
            keepConnected: 'iojaoj hjaoi uci zi wyiay',
            loginWith: 'lozo kjwoui jchn iuish jak',
            or: 'OS',
            enterDetails: 'ozjon ajhjk ygzui uchiz 78w',
            yourJourney: 'zopjo ajcji whbkzjx fjhssi',
            createAccount: 'Aojsljf Aklanln | AOJSLJF AKLANLN',
            passwordMustContain: 'ojzocja ajkkdj ak j',
            oneNumeric: 'One Numeric Character',
            specialCharacter: 'One Special Character',
            haveAnAccount: 'kajpz ahdkj zuxih?',
            email: 'Email',
            password: 'Password',
            phoneNumber: 'djaof knacjh',
            firstName: 'djan jakjf', 
            lastName: 'ajofja aijoj',
            confirmPassword: 'kajo hajhfdjh',
            passwordLackingError: 'Password should include at least one alphanumeric character and one special character',
            successfullySignedUp: 'You have successfully signed up. Please check your mail for a confirmation link',
            loginSuccessful: 'aofjdoi huchz',
            confirmPasswordError: 'ajfndjk aciouj sj isjd ijap',
            passwordsDontMatch: `ajfodj dja f i joj`
        },
        /***** Modals */
        ...
        createTargetModal: {
            title: 'Create Target',
            monthlyTarget: 'Retail Outlet Monthly Sales Target',
